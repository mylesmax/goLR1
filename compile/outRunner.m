...
opts.VariableNames = ["t", "V", "m", "h", "j", "d", "f", "X", "Xi", "K1", "Kp", "INa", "Isi", "Ik", "IK1", "IKP", "Ib"];
...
title("LR1 Ventricular Action Potential", FontSize=16)
...
title("Evolution of Gating Variables of LR1 Ventricular Action Potential", FontSize=16)
